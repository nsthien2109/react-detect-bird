...
import bellIcon from '../../../../assets/svgs/bell-ic.svg';
import ordIcon from '../../../../assets/svgs/order-ic.svg';
import famIcon from '../../../../assets/svgs/fam-ic.svg';
      ...
      <div className="dashboard">
        <div className="dashboard-wrapper">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10 dashboard-stats-grid">
            ...
            <CardStatistic icon={famIcon} title="Families" statistic={stats.families ?? 0} />
            <CardStatistic icon={ordIcon} title="Orders" statistic={stats.orders ?? 0} />
            <CardStatistic icon={bellIcon} title="Status" statistic={stats.status ?? 0} />
          </div>
        </div>
      </div>
    </>
